...
import { mapIncludes } from './util-map-includes';
...
export function resolveFlowCollection(
    ...
    const coll = isMap ? (new YAMLMap(ctx.schema) as YAMLMap.Parsed) : (new YAMLSeq(ctx.schema) as YAMLSeq.Parsed);
    coll.flow = true;
