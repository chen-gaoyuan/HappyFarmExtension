...
import { isDocument, isNode, isPair, MAP, Node, SEQ } from '../nodes/Node';
...
function findTagObject(value: unknown, tagName: string | undefined, tags: Array<ScalarTag | CollectionTag>) {
    if (tagName) {
...
export function createNode(value: unknown, tagName: string | undefined, ctx: CreateNodeContext): Node {
