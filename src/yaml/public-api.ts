...
import { Document, Replacer } from './doc/Document';
import { prettifyError, YAMLParseError } from './errors';
...
export function parseAllDocuments<T extends ParsedNode = ParsedNode>(
    ...
    return Object.assign<Document.Parsed<T>[], { empty: true }, ReturnType<Composer['streamInfo']>>(
        [],
        { empty: true },
        composer.streamInfo(),
    );
 ...
 */
export function parse(src: string, options?: ParseOptions & DocumentOptions & SchemaOptions & ToJSOptions): any;
...
export function parse(
    src: string,
    reviver?: Reviver | (ParseOptions & DocumentOptions & SchemaOptions & ToJSOptions),
    options?: ParseOptions & DocumentOptions & SchemaOptions & ToJSOptions,
): any {
...
export function stringify(
    value: any,
    replacer?: Replacer | (DocumentOptions & SchemaOptions & ParseOptions & CreateNodeOptions & ToStringOptions) | null,
    options?: string | number | (DocumentOptions & SchemaOptions & ParseOptions & CreateNodeOptions & ToStringOptions),
) {
