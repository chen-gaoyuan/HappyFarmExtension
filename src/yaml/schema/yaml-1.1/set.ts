...
import { isMap, isPair, isScalar } from '../../nodes/Node';
import { createPair, Pair } from '../../nodes/Pair';
import { Scalar } from '../../nodes/Scalar';
import { ToJSContext } from '../../nodes/toJS';
import { YAMLMap, findPair } from '../../nodes/YAMLMap';
...
export class YAMLSet<T = unknown> extends YAMLMap<T, Scalar<null> | null> {
    ...
    add(key: T | Pair<T, Scalar<null> | null> | { key: T; value: Scalar<null> | null }) {
    ...
    createNode(schema, iterable, ctx) {
        ...
        if (iterable && Symbol.iterator in Object(iterable))
            for (let value of iterable as Iterable<unknown>) {
                ...
                set.items.push(createPair(value, null, ctx) as Pair<unknown, Scalar<null>>);
            }
        return set;
    },
};
