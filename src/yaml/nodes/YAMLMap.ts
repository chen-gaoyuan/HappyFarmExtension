...
import { stringifyCollection } from '../stringify/stringifyCollection';
import { addPairToJSMap } from './addPairToJSMap';
import { Collection } from './Collection';
import { isPair, isScalar, MAP, ParsedNode, Range } from './Node';
import { Pair } from './Pair';
import { isScalarValue, Scalar } from './Scalar';
import type { ToJSContext } from './toJS';

export function findPair<K = unknown, V = unknown>(items: Iterable<Pair<K, V>>, key: unknown) {
...
export declare namespace YAMLMap {
    interface Parsed<K extends ParsedNode = ParsedNode, V extends ParsedNode | null = ParsedNode | null>
        extends YAMLMap<K, V> {
        items: Pair<K, V>[];
        range: Range;
...
export class YAMLMap<K = unknown, V = unknown> extends Collection {
     ...
     */
    toJSON<T = unknown>(_?: unknown, ctx?: ToJSContext, Type?: { new (): T }): any {
