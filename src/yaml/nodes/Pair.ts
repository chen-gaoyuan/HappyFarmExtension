import { createNode, CreateNodeContext } from '../doc/createNode';
import type { CollectionItem } from '../parse/cst';
import type { Schema } from '../schema/Schema';
import type { StringifyContext } from '../stringify/stringify';
import { stringifyPair } from '../stringify/stringifyPair';
import { addPairToJSMap } from './addPairToJSMap';
import { isNode, NODE_TYPE, PAIR } from './Node';
import type { ToJSContext } from './toJS';

export function createPair(key: unknown, value: unknown, ctx: CreateNodeContext) {
