import { createNode } from '../doc/createNode';
import type { Schema } from '../schema/Schema';
import { isCollection, isNode, isPair, isScalar, NodeBase, NODE_TYPE } from './Node';

export function collectionFromPath(schema: Schema, path: unknown[], value: unknown) {
    let v = value;
...
export const isEmptyPath = (path: Iterable<unknown> | null | undefined): path is null | undefined =>
...
export abstract class Collection extends NodeBase {
    ...
    clone(schema?: Schema): Collection {
        const copy: Collection = Object.create(Object.getPrototypeOf(this), Object.getOwnPropertyDescriptors(this));
    ...
    hasAllNullValues(allowScalar?: boolean) {
        return this.items.every((node) => {
            ...
            const n = node.value;
            return (
                n == null || (allowScalar && isScalar(n) && n.value == null && !n.commentBefore && !n.comment && !n.tag)
            );
        });
    }
