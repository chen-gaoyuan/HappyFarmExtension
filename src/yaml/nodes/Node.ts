...
export const isAlias = (node: any): node is Alias => !!node && typeof node === 'object' && node[NODE_TYPE] === ALIAS;

export const isDocument = <T extends Node = Node>(node: any): node is Document<T> =>
    !!node && typeof node === 'object' && node[NODE_TYPE] === DOC;

export const isMap = <K = unknown, V = unknown>(node: any): node is YAMLMap<K, V> =>
    !!node && typeof node === 'object' && node[NODE_TYPE] === MAP;

export const isPair = <K = unknown, V = unknown>(node: any): node is Pair<K, V> =>
...
export function isCollection<K = unknown, V = unknown>(node: any): node is YAMLMap<K, V> | YAMLSeq<V> {
...
export const hasAnchor = <K = unknown, V = unknown>(node: unknown): node is Scalar<V> | YAMLMap<K, V> | YAMLSeq<V> =>
...
export abstract class NodeBase {
    ...
    clone(): NodeBase {
        const copy: NodeBase = Object.create(Object.getPrototypeOf(this), Object.getOwnPropertyDescriptors(this));
