...
import { foldFlowLines, FoldOptions, FOLD_BLOCK, FOLD_FLOW, FOLD_QUOTED } from './foldFlowLines';
...
function plainString(item: StringifyScalar, ctx: StringifyContext, onComment?: () => void, onChompKeep?: () => void) {
...
export function stringifyString(item: Scalar, ctx: StringifyContext, onComment?: () => void, onChompKeep?: () => void) {
