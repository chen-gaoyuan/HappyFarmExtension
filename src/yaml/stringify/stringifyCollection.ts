...
import { isNode, isPair } from '../nodes/Node';
import { stringify, StringifyContext } from './stringify';
...
function stringifyBlockCollection(
    ...
    ctx: StringifyContext,
    { blockItemPrefix, flowChars, itemIndent, onChompKeep, onComment }: StringifyCollectionOptions,
) {
    const {
        indent,
